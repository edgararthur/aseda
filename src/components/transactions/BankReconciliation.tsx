					...
					<div className="p-6">
						...
						<header className="flex justify-between items-center mb-4">
							<div className="flex justify-between align-middle w-full">
								<div>
									<h1 className="text-lg font-medium text-gray-700">Bank Reconciliation</h1>
								...
								{isVisible && (<div className="flex gap-2">
									<button onClick={() => {
										...
										<Plus size={16} /> Add Bank Reconcilement
									</button>
								</div>
								)}
							</div>
							...
							<div className='min-w-full h-full p-3 border-gray-200 border bg-white rounded-md'>
								...
								<table className="min-w-full rounded-lg mt-5">
									<thead className='text-gray-500 text-xs font-normal'>
										<tr>
											<th className='py-2 px-4 border-b text-gray-700 font-medium'>Bank Account Id</th>
											<th className="py-2 px-4 border-b text-gray-700 font-medium">Statement Date</th>
											<th className="py-2 px-4 border-b text-gray-700 font-medium">Transaction List</th>
											<th className="py-2 px-4 border-b text-gray-700 font-medium">Reconcile Status</th>
