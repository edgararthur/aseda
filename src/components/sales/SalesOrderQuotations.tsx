...
export default function SalesOrderQuotations() {
					...
					<div className="p-6">
						...
						<header className="flex justify-between items-center mb-4">
							<div className="flex justify-between align-middle w-full">
								<div>
									<h1 className="text-lg font-medium text-gray-700">Orders & Quotation</h1>
									<p className='text-xs'>Manage your quotations</p>
								</div>
								{isVisible && (<div className="flex gap-2">
									<button onClick={() => {
										...
										<Plus size={16} /> Add Order/Quotation
									</button>
								</div>
								)}
							</div>
							...
							<div className='min-w-full h-full p-3 border-gray-200 border bg-white rounded-md'>
								...
								<table className="min-w-full rounded-lg mt-5">
									...
									<tbody>
										{products.length === 0 ? (
											<tr>
												<td colSpan={9} className="text-center text-xs pt-2 font-medium text-gray-700">Sorry no orders/quotations available.</td>
											</tr>
										) : (
