					...
					<div className="p-6">
						...
						<header className="flex justify-between items-center mb-4">
							<div className="flex justify-between align-middle w-full">
								<div>
									<h1 className="text-lg font-medium text-gray-700">Sales Returns</h1>
									<p className='text-xs'>Manage your returns</p>
								</div>
						...
						<div className='min-w-full h-full p-3 border-gray-200 border bg-white rounded-md'>
							<div className="flex align-middle justify-between w-full">
								...
								<div className="flex align-middle">
									<button onClick={handleExportToPDF} className="bg-transparent text-red-400 border-none px-2 py-2 rounded flex items-center">
										<FaFilePdf size={20}/>
									</button>
							...
							<table className="min-w-full rounded-lg mt-5">
								<thead className='text-gray-500 text-xs font-medium'>
									<tr>
										...
										<th className="py-2 px-4 border-b text-gray-700 font-medium">Customer</th>
										<th className="py-2 px-4 border-b text-gray-700 font-medium">Status</th>
										<th className="py-2 px-4 border-b text-gray-700 font-medium">Grand Total</th>
