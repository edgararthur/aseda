					...
					<div className="p-6">
						...
						<header className="flex justify-between items-center mb-4">
							<div className="flex justify-between align-middle w-full">
								<div>
									<h1 className="text-lg font-medium text-gray-700">Purchase Returns</h1>
						...
						<div className='min-w-full h-full p-3 border-gray-200 border bg-white rounded-md'>
							...
							<table className="min-w-full rounded-lg mt-5">
								<thead className='text-gray-500 text-xs font-medium'>
									<tr>
										<th className='py-2 px-4 border-b text-gray-700 font-medium'>Product</th>
										<th className="py-2 px-4 border-b text-gray-700 font-medium">Date</th>
										<th className="py-2 px-4 border-b text-gray-700 font-medium">Supplier</th>
								...
								{invoices.length === 0 ? (
									<tr>
									<td colSpan={9} className="text-center text-xs pt-2 font-medium text-gray-700">Sorry there hasn't been any purchase returns yet.</td>
									</tr>
								) : (
